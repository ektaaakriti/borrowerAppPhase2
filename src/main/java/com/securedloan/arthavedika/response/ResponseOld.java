package com.securedloan.arthavedika.response;
	...
	public class ResponseOld {
		...
		public ResponseOld(String message, boolean status, GroupData grpData) {
			super();
		...
		public ResponseOld(String message, boolean status, List<PsyQstn> psyQstnList, Applicant applicant) {
			super();
			this.message = message;
			this.status = status;
			PsyQstnList = psyQstnList;
		...
		public ResponseOld(String message, boolean status, Applicant applicant) {
			super();
			this.message = message;
			this.status = status;
			this.applicant = applicant;
		...
		public ResponseOld(String message, boolean status, boolean imageResultStatus) {
			super();
			this.message = message;
			this.status = status;
		...
		public ResponseOld( List<DocEkyc> docEkyc,String message, boolean status) {
			super();
		...
		public ResponseOld(String message, boolean status, List<EKYC> ekycList) {
			super();
			this.message = message;
			this.status = status;
			EkycList = ekycList;
		...
		public ResponseOld(String message, boolean status, User user) {
			super();
			this.message = message;
			this.status = status;
			this.user = user;
		...
		public ResponseOld(String registerSuccess, Boolean true1, List<Applicant> applicants) {
			// TODO Auto-generated constructor stub
		}
